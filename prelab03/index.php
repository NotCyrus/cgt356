...
<form id="form0" action="getFormData.php" method="post">
	<fieldset id="billing">
        ...
        <ul>
            ...
            <li> <label title="Comments" for="comments">Questions or Comments <span>*</span></label><input type="text" name="comments" id="comments" size="30" maxlength="30" /></li>
        </ul>
    </fieldset> 
    <fieldset id="shipping">
        ...
        <ul>
            ...
            <li> <label title="SZip" for="Szip">Zip <span>*</span></label><input type="text" name="Szip" id="Szip" size="30" maxlength="30" /></li>
