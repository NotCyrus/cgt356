...
<form id="form0" action="storeInfo.php" method="post">
	<fieldset id="billing">
        ...
        <ul>
            ...
            <li> <label title="Zip" for="zip">Zip Code <span>*</span></label><input type="text" name="zip" id="zip" size="30" maxlength="30" value="<?php if(!empty($_SESSION["zip"])){echo($_SESSION["zip"]);} ?>" /></li>
    ...
    <fieldset id="shipping">
        ...
        <ul>
            ...
            <li> <label title="SZip" for="Szip">Zip Code <span>*</span></label><input type="text" name="Szip" id="Szip" size="30" maxlength="30" value="<?php if(!empty($_SESSION["Szip"])){echo($_SESSION["Szip"]);} ?>" /></li>
