...
for($i=0; $i < $num_results; $i++)
{
	...
	if($catName==$row["CategoryName"] || empty($catName))
	{
		$_SESSION['catAddFail'] = 'Failed to add category';
		header("Location:superAdmin.php");
	}

	else
	{
	mysql_query("INSERT INTO Category VALUES ('$catName', 0)");	
	$_SESSION['catAddFail'] = 'Successfully added a new category!';
	header("Location:superAdmin.php");
	}
